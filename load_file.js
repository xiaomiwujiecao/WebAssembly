...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'load_file.data';
      var REMOTE_PACKAGE_BASE = 'load_file.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_load_file.data');

      };
      Module['addRunDependency']('datafile_load_file.data');
   ...
   loadPackage({"files": [{"filename": "/hello_world_file.txt", "start": 0, "end": 199, "audio": 0}], "remote_package_size": 199, "package_uuid": "590d06b9-c231-4aea-abe0-2c97491581d7"});
...
var wasmBinaryFile = 'load_file.wasm';
